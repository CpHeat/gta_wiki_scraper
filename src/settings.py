...
UNAVAILABLE_VEHICLES_PAGE_URL = "https://gta.fandom.com/wiki/Category:Vehicles_removed_for_purchase_in_GTA_Online:_San_Andreas_Mercenaries"
UNAVAILABLE_VEHICLES_PAGE_OUTPUT = f"{SCRAPED_FOLDER}/unavailable_vehicles.html"
VEHICLES_CSV_OUTPUT = f"{OUTPUT_FOLDER}/vehicles.csv"
VEHICLES_FIELDNAMES = ("name", "page url", "image url", "category", "type", "body style", "capacity", "speed (km/h)", "speed (mph)", "price", "drivetrain", "modifications", "model name", "available")
...
APARTMENTS_FIELDNAMES = ("name", "page url", "image url", "category", "style", "price", "garage capacity", "price", "notes")
